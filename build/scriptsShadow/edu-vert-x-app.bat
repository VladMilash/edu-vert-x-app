...
set CLASSPATH=%APP_HOME%\lib\edu-vert-x-app-1.0.0-SNAPSHOT-fat.jar

@rem Execute edu-vert-x-app
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %EDU_VERT_X_APP_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%EDU_VERT_X_APP_EXIT_CONSOLE%" exit 1
exit /b 1
